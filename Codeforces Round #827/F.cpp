...
void solve(int64_t test_cases)
{
	...
	while(q --)
	{
		...
		if (ma.begin()->first < mb.rbegin()->first)
		{
			cout << "YES" << endline;
		}
		elif (ma.begin()->first == mb.rbegin()->first)
		{
			if (ma.begin()->second < mb.rbegin()->second)
			{
				if (ma.rbegin()->first == ma.begin()->first)
					cout << "YES" << endline;
				else
					cout << "NO" << endline;
			}
