...
void systemOfEquation(int32_t a1, int32_t b1, int32_t c1, int32_t a2, int32_t b2, int32_t c2);
/***********************************************************/
driver main(){
	...
	while (n --)
	{
		...
		systemOfEquation(a1, b1, c1, a2, b2, c2);
	}
	//finish();
	return 0;
}
...
void systemOfEquation(int32_t a1, int32_t b1, int32_t c1, int32_t a2, int32_t b2, int32_t c2)
{
	...
	if (D == 0)
	{
		if (Dx + Dy == 0) cout << "INFINITE" << endl;
		else cout << "NO SOLUTION" << endl;
		return (void)("ket thuc D == 0");
	}
	if ((Dx % D != 0) || Dy % D != 0) cout << "NO SOLUTION" << endl;
	else cout << Dx / D << " " << Dy / D << endl;
}
/*
