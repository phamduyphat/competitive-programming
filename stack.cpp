...
/*
    ưu tiện w1 + c1 tăng dần
    GS ở 1 thời điểm tổng trọng lượng của tháp là T gồm k hộp
    trọng lượng kế tiếp (wi, ci): ci < T 


    Phương án 1:
        loại bỏ hộp i   -> (T, k)
    Phương án 2:
        bỏ 1 hộp trong tháp để xếp được hộp i xuống đáy     Ci >= T - wj
                                                            --> (T - wj + wi, k)
        cần chọn hộp loại bỏ nặng nhất trong tháp
    ...
    cách dp:
    sắp xếp c tăng dần
    duy trì b[] b[i]: tổng trọng lượng nhỏ nhất nếu xếp tháp có i hoopj
    ...
    xét hợp (wi, ci)
        ...
        => xếp (wi, ci) xuống đáy tháp i h
        => tháp l + 1 hộp, trọng lượng b[l] + wi;
        --> 
*/