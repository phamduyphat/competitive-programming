...
struct sub1{
    int32_t dijkstra(int32_t &x, int32_t &n, vector<vector<pair<int32_t, int32_t>>> &adj)
    {
    ...
    sub1(vector<vector<pair<int32_t, int32_t>>> &adj)
    {
        int32_t temp;
        cin >> temp;
        cout << dijkstra(temp, n, adj);
    }
};
struct sub2
{
    sub2(vector<vector<pair<int32_t, int32_t>>> &adj)
    {
        fr1(i, k)
        {
            int32_t temp;
