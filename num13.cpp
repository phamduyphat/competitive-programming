...
vector<vector<int32_t>> save(100010, vector<int32_t> (13, -1));
/***********************************************************/
//Functions declarations:
int32_t duyet(int32_t i, int32_t r, int32_t n)
{
    if (save[i][r] != -1) return save[i][r];
    if (i == 0)
    {
        if (r == 0) 
        {
