...
driver main(){
    ...
    str s, ss;
    cin >> s >> ss;
    char a = tolower(s[0]), b = tolower(ss[0]);
    if (a == b) {cout << "Same" << endline; return 0;}
    if (a < b) swap (a, b);
    if ((a == 'y' && b == 'v') || (a == 'r' && b == 'g') || (a == 'o' && b == 'b')) {cout << "Complementary"; return 0;}
    if (a == 'y')
    {
        if (b == 'g' || b == 'o') {cout << "Adjacent"; return 0;}
    }
    if (a == 'v') if (b == 'r' || b == 'b'){cout << "Adjacent"; return 0;}
    if (a == 'r') if (b == 'o') {cout << "Adjacent"; return 0;}
    if (a == 'g') if (b == 'b') {cout << "Adjacent"; return 0;}

    if (a == 'y' && b == 'r') {cout << "Orange"; return 0;}
    if (a == 'o' && b == 'g') {cout << "Yellow"; return 0;}
    if (a == 'y' && b == 'b') {cout << "Green"; return 0;}
    if (a == 'v' && b == 'g') {cout << "Blue"; return 0;}
    if (a == 'r' && b == 'b') {cout << "Violet"; return 0;}
    if (a == 'v' && b == 'o') {cout << "Red"; return 0;}
    // finish();
    return 0;
}
//functions content: